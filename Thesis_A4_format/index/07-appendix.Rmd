...
```{r apa11, echo=FALSE,  out.width = '60%',fig.pos="hbt!", fig.align="center", fig.scap="Representation of the cumulative number of studies using different sap flow methods between 1957 and 2017",fig.cap="(ref:apa11)"}
...
colnames(table2) <- capitalize_str(colnames(table2))
  ...
  knitr::kable(table2,"latex", booktabs = TRUE, escape = FALSE, longtable = FALSE, linesep = "",
    ...
    kableExtra::kable_styling(latex_options = c("scale_down","HOLD_position"),font_size = 12) %>% 
    column_spec(c(2), width = '20em') %>% 

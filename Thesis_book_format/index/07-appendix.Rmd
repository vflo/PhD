...
```{r spparamplot, echo=FALSE, out.width = '90%', fig.cap="Water use parameters at the species level. Grey dashed lines are the weighted mean of the parameters",  fig.align='center'}
